...
cd C:\Users\AlokShah\Documents\GitHub\erp-react\outputs\frontend
call npm install
cd ..
echo.
...
start "Backend Server - Port 5000" cmd /k "cd backend && echo Backend starting... && python backend.py"
